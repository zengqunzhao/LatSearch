...
def _insert_adapter_name_into_state_dict(
    state_dict, adapter_name: str, parameter_prefix: str
):
...
# There is an inconsistency between the model key and the pre-trained model key for the VideoReward model
